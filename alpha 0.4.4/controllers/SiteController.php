...
class SiteController extends Controller{
    ...
    public function __construct() {
        // Apply CSRF protection to all actions except 'home'
        $this->registerMiddleware(new CsrfMiddleware(['home']));
    }
    ...
    public function coursesAction(Request $request) {
        ...
        $courseId = $request->getParam('id'); // Get the course ID from the route parameter
        $courses = [
            'mso' => [
                'title' => 'MS Office Applications',
                'description' => 'Comprehensive, practical training on Microsoft Office suite and essential desktop skills for workplace productivity.',
