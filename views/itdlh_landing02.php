        ...
        <div class="col-md-4">
          <div class="card h-100">
            ...
            <div class="card-body">
              ...
              <p><a class="btn btn-outline-primary" href="<?php echo $this->asset('itdlh/course?id=mso'); ?>">View Course</a></p>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="card h-100">
            ...
            <div class="card-body">
              ...
              <p><a class="btn btn-outline-primary" href="<?php echo $this->asset('itdlh/course?id=web'); ?>">View Course</a></p>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="card h-100">
            ...
            <div class="card-body">
              ...
              <p><a class="btn btn-outline-primary" href="<?php echo $this->asset('itdlh/course?id=python'); ?>">View Course</a></p>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="card h-100">
            ...
            <div class="card-body">
              ...
              <p><a class="btn btn-outline-primary" href="<?php echo $this->asset('itdlh/course?id=java'); ?>">View Course</a></p>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="card h-100">
            ...
            <div class="card-body">
              ...
              <p><a class="btn btn-outline-primary" href="<?php echo $this->asset('itdlh/course?id=php'); ?>">View Course</a></p>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="card h-100">
            ...
            <div class="card-body">
              ...
              <p><a class="btn btn-outline-primary" href="<?php echo $this->asset('itdlh/course?id=graphic'); ?>">View Course</a></p>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="card h-100">
            ...
            <div class="card-body">
              ...
              <p><a class="btn btn-outline-primary" href="<?php echo $this->asset('itdlh/course?id=english'); ?>">View Course</a></p>
            </div>
          </div>
        </div>
      </div>
