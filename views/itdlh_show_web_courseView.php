    ...
    <div class="row gx-5 align-items-center">
      ...
      <div class="col-md-6">
        ...
        <?php if (!empty($course['duration'])): ?>
          <p><span class="badge bg-primary me-2 course-duration"><?php echo htmlspecialchars($course['duration']); ?></span></p>
        <?php endif; ?>

        <?php if (!empty($course['fee'])): ?>
          <p>
            <span class="badge course-fee-badge me-2">Course Fee: <?php echo htmlspecialchars($course['fee']); ?></span>
          </p>
        <?php endif; ?>
